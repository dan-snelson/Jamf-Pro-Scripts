...
outputFileName="$loggedInUserHome/Desktop/$machineName-ComputerDiskUsage.txt"



# Output to user
/bin/echo "--------------------------------------------------------------------------------------------------------------" > $outputFileName
/bin/echo "`now` Disk usage for \"$volumeName\" on computer \"$machineName\"" >> $outputFileName
